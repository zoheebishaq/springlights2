...
import fr.laerce.lights.impl.AmpouleIncandescente;
import fr.laerce.lights.impl.Luminaire;
...
public class App {
    ...
    public void brancher (Luminaire unLuminaire){
        Eclairage uneAmpoule = new AmpouleIncandescente();
        unLuminaire.setAmpoule1(uneAmpoule);
        unLuminaire.setAmpoule2(uneAmpoule);
        unLuminaire.setAmpoule3(uneAmpoule);
        unLuminaire.setAmpoule4(uneAmpoule);
...
//        app.brancher((Luminaire) app.eclairage);
